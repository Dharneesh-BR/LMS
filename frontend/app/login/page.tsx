          ...
          {mode === "signup" ? (
            <div className="mt-4 grid gap-4 sm:grid-cols-2">
              ...
              <div>
                ...
                <select
                  className="mt-1 w-full rounded-xl border border-gray-200 bg-white px-4 py-3 text-gray-950 outline-none transition focus:border-ocean focus:bg-white focus:ring-4 focus:ring-ocean/10"
                  value={department}
